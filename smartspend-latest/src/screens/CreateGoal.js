        ...
        <View style={styles.containerHeader}>
          ...
          {goals.length === 0 && (
            <Ionicons
              ...
              size={40}
              color="#41DC40"
              onPress={() => navigation.navigate("Add Create a Goal Savings")}
            />
          )}
        </View>
        ...
        {goals.map((item) => (
          <View style={styles.containerExpense} key={item.id}>
            <View>
              ...
              <Text style={styles.incomeDescription}>Cost: ₱{item.cost - item.expenses.reduce(
              ...
              <Text style={styles.incomeDescription}>
                ...
                {`${item.expenses.reduce(
                  (acc, expense) => acc + parseFloat(expense.expense),
                  0
                )}/${item.cost - item.expenses.reduce(
                  (acc, expense) => acc + parseFloat(expense.expense),
                  0
                )}`}
              </Text>
            ...
            <View style={{ flexDirection: "row" }}>
              <Ionicons
                ...
                color="black"
                onPress={() =>
                  navigation.navigate("Edit Create a Goal Savings", {
                    item: item,
                  })
                }
              />
